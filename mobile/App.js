      ...
      {pantalla === 'visita' && (
        <ScrollView>
          <View style={styles.card}>
            ...
            <Selector label="Rubro *" valor={visitaForm.rubro} onChange={v => setVisitaForm({ ...visitaForm, rubro: v })} opciones={[{ value: 'kiosco', label: 'Kiosco' }, { value: 'maxikiosco', label: 'Maxikiosco' }, { value: 'drugstore', label: 'Drugstore' }, { value: 'almacen', label: 'Almacén' }, { value: 'minimercado', label: 'Minimercado' }, { value: 'mercado', label: 'Mercado' }, { value: 'supermercado', label: 'Supermercado' }, { value: 'distribuidor', label: 'Distribuidor' }, { value: 'gastronomico', label: 'Gastronómico' }, { value: 'heladeria', label: 'Heladería' }, { value: 'escuela', label: 'Escuela' }, { value: 'club', label: 'Club' }, { value: 'otros', label: 'Otros' }]} />
            <Selector label="Resultado *" valor={visitaForm.resultado} onChange={v => setVisitaForm({ ...visitaForm, resultado: v })} opciones={[{ value: 'venta', label: 'Venta' }, { value: 'cotizacion', label: 'Cotización' }, { value: 'no_interesado', label: 'No interesado' }, { value: 'tiene_mercaderia', label: 'Tiene mercadería' }, { value: 'otro', label: 'Otro' }]} />
